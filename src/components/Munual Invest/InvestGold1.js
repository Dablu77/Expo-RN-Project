...
export default function InvestGold1({ navigation }) {
    ...
    return (
        <View style={{ backgroundColor: 'black', height: 900 }}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: 18, marginVertical: -20, }}>
                <CustomButton Title="in Amount" onPress={() => navigation.navigate("InvestGold12")} />
                <CustomButton2 Title="in Grams" />
